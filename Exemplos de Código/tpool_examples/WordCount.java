...
class Document {
    ...
    Document(String fileName, List<String> lines) {
...
/* ......................................................................................... */
    ...
    Long occurrencesCount(Document document, String searchedWord) {
        ...
        if (count > 0) {
          System.out.printf("%s: '%s' found %d times%n", document.getFileName(), searchedWord, count);
        }
        return count;
    }
...
/* ......................................................................................... */
    ...
    public static void main(String[] args) throws IOException {
        ...
        final int repeatCount = args.length > 1 ? Integer.decode(args[2]) : 5;
        long counts;
        long startTime;
        long stopTime;
        ...
        for (int i = 0; i < repeatCount; i++) {
            ...
            counts = wc.countOccurrencesOnSingleThread(folder, word);
            stopTime = System.currentTimeMillis();
            singleThreadTimes[i] = (stopTime - startTime);
            System.out.println(counts + " occurrences, single thread search took " + singleThreadTimes[i] + "ms");
        }
        
        for (int i = 0; i < repeatCount; i++) {
          System.out.println("===========================");
            startTime = System.currentTimeMillis();
            counts = wc.countOccurrencesInParallel(folder, word);
            stopTime = System.currentTimeMillis();
            forkedThreadTimes[i] = (stopTime - startTime);
            System.out.println(counts + " occurrences, fork / join search took " + forkedThreadTimes[i] + "ms");
        }
